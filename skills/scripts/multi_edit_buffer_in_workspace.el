...
matching (whitespace, newlines, indentation). Use actual content - NO line numbers.\n\nEdits apply in array \
order. If ANY edit fails, ALL changes are rolled back."
 :category "execution"
 :args
 '((
    :name "buffer_name" :type string :description "The name of the target buffer")
   (
 ...
 :success-fn
 (lambda (res _payload)
   (format "SUCCESS: Virtual multi-edit recorded for buffer '%s'. A patch will be generated at the end of the \
turn."
