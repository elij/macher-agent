...
non-blocking manner. Spawn subagents before calling"
...
execution completed with status: %s"
 ...
 (lambda (buffer-names _payload)
   (format "SUCCESS: Dispatched %d sub-agents in the background. They are executing independently and \
asynchronously. Your current buffer remains unblocked and you can proceed with other tasks immediately."
           (length buffer-names))))
